...
A basic application designed for the Nicolau Copernic Institute. It allows both new and existing students to enroll in new offers published by companies with access to the platform. The application is built with a Java Spring Boot REST API backend and a ReactJS frontend on docker containers.
